...
\cvevent{Fullstack + DevOps engineer}{Veradat Smart Network S.A. de C.V}{August 2024 -- Present}{México, Hybrid mode}
\begin{itemize}
	...
	\item Microservices development using: \textbf{Maven}, \textbf{Java}, \textbf{Spring Cloud} and \textbf{API REST}.
	\item Message broker using: \textbf{RabbitMQ}.
